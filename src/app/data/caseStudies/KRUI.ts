...
aboutParagraphs: [
  ...
  },
  {
    ...
    heroImages: [
      ...
      {
        src: hero3,
        alt: "KRUI interface screens",
        backgroundColor: "#7F65BC",
      },
      {
        src: hero4,
        alt: "KRUI interface screens",
        backgroundColor: "#217C85",
      },
    ],
  },
  sections: [
    ...
    
    {
      ...
      type: "richText",
      background: "#0a0a0a",
      fontSize: "3.5rem",         // controls the whole block — use rem, px, vw, anything CSS accepts
...

    {
      ...
      numberSize: "1.5rem",
      titleSize: "1.2rem",
      arrowSize: 60,       descriptionSize: "1rem",
      ...
      steps: [
        {
          ...
          description: "Designers+ Design Managers",
        },
        {
          number: "STEP 2",
          title: "Component audit",
          description: "Designers+ Engineers",
        },
        {
          number: "STEP 3",
          title: "Standardization",
          description: "ICs + Managers",
        },
        {
          number: "STEP 4",
          title: "Guidance definition",
          description: "Designers + Product Managers",
        },
        {
          number: "STEP 5",
          title: "Track backlogs",
          description: "Managers + Deadlines",
        },
      ],
    },
      ...
      cards: [
        {
          ...
          metric: "25% increase in design consistency",
          description: "Measured across all KRADOS apps after first cycle",
        },
        {
          category: "Org alignment",
          metric: "3 managers + 50+ ICs aligned",
          description: "Design system adoption added to team roadmaps.",
        },
        {
          category: "Engineering",
          metric: "30% improvement in development efficiency",
          description: "Standardized components reduced rebuild time per sprint",
        },
        {
          category: "Ripple effect",
          metric: "DC Team approval added to release process",
          description: "Changed how KRADOS ships front-end work org-wide",
        },
      ],
    },
  ],
