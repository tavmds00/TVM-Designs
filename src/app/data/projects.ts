...
export const projects: Project[] = [
  {
    ...
    mediaTopLabel: "Every Marine.\nEvery Item.\nAccounted For.",
    mediaStat: "Saving Marines 3 Hours\nPer Inventory. Per Unit.",
  ...
  },
  {
    ...
    mediaStat: "Reduced wait times by 55%!\n118 min → 52 min.",
  ...
  },
  {
    ...
    mediaBgSrc: wavBg,
    mediaTopLabel: "Shipped WAV Media",
